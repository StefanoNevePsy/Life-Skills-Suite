    ...
    return (
      <div className="min-h-screen bg-yellow-50 p-4 sm:p-6 font-sans selection:bg-yellow-200 flex flex-col">
        ...
        <main className="max-w-6xl mx-auto flex flex-wrap justify-center gap-8 pb-10">
          ...
          <Card title="Metafore Visive" subtitle="Fotolinguaggio & Blob Trees" icon={Sparkles} color="bg-indigo-200" description="Fotolinguaggio con set fotografici d'autore e Blob Trees interattivi per identificazione e vissuti emotivi." onClick={() => handleViewChange('visual_metaphors')} />
        </main>
