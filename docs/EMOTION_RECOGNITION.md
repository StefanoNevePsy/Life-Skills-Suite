...
Il docente conferma di poter condividere le immagini. Non usare archivi di ricerca in un sito pubblico senza la relativa autorizzazione. Le immagini generate vanno classificate come tali, non come fotografie reali.
...
Il pulsante Salva richiede la conferma di poter condividere le immagini: i requisiti mancanti sono mostrati accanto al pulsante. La conversione WebP riguarda le nuove importazioni; le immagini già salvate non vengono modificate.
